...
std::string sysDescr = "SNMP Agent DataGuard";
std::string sysObjectID = "32023";
int sysUptime = 0;
...
std::string entPhysicalDescr_1 = "DataGuard Temperature and Humidity Sensor";
...
static const unsigned long SENSOR_UPDATE_INTERVAL = 500;
...
void printFile(const char* dataguard_log);
//************************************
